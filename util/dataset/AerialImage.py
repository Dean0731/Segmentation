...
class AerialImage(Dataset.Dataset):
    ...
    def setDataset(self,flag='tif_576'):
        if flag == 'tif_576':
            self.train_dir = r'AerialImage576\train'
            self.val_dir = r'AerialImage576\val'
            self.test_dir = r'AerialImage576\test'
            print('tif_576')
        elif flag =='tif_3072':
            self.train_dir = r'AerialImage3072\train'
            self.val_dir = r'AerialImage3072\val'
            self.test_dir = r'AerialImage3072\test'
            print('tif_3072')
        else:
            print("未找到数据集")
            exit()
