...
from tensorflow.keras.layers import Conv2D,Lambda, BatchNormalization, Input,Add,Activation,DepthwiseConv2D,MaxPooling2D,UpSampling2D,Concatenate,ZeroPadding2D
...
if __name__ == '__main__':
    ...
    # Segnet(512,512,3).to_json()
    Segnet(512,512,3).make_train_function()
