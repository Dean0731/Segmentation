...
from paddlex.cv.nets.segmentation.model_utils.libs import sigmoid_to_softmax
from paddlex.cv.nets.segmentation.model_utils.loss import softmax_with_loss
from paddlex.cv.nets.segmentation.model_utils.loss import dice_loss
from paddlex.cv.nets.segmentation.model_utils.loss import bce_loss
